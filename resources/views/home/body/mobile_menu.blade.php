            ...
            <ul>
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="{{ asset('frontend/index-02.html') }}">
                                Home 02
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('frontend/index-03.html') }}">
                                Home 03
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="{{ asset('frontend/pricing.html') }}">Pricing</a></li>
                        <li class="menu-item-has-children">
                            <a class="no-border" href="#">Integratios</a>
                            <ul class="sub-menu">
                                <li><a href="{{ asset('frontend/integration.html') }}">Integratios</a></li>
                                <li><a href="{{ asset('frontend/single-integration.html') }}">Integratios
                                        Details</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ asset('frontend/single-team.html') }}">team details</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
